...
public class EnemyTestMap extends GeneralMap {
    ...
    public EnemyTestMap(DisplayToolkit tool) {
        ...
        mapArray[0][1] = new BlockGeneral(0, 1, BlockGeneral.Blocktypes.AIR);
        mapArray[1][1] = new BlockGeneral(1, 1, BlockGeneral.Blocktypes.STONE);
        mapArray[2][1] = new BlockGeneral(2, 1, BlockGeneral.Blocktypes.AIR);
        mapArray[3][1] = new BlockGeneral(3, 1, BlockGeneral.Blocktypes.AIR);
        mapArray[4][1] = new BlockGeneral(4, 1, BlockGeneral.Blocktypes.AIR);
        ...
        mapArray[0][3] = new BlockGeneral(0, 3, BlockGeneral.Blocktypes.AIR);
        mapArray[1][3] = new BlockGeneral(1, 3, BlockGeneral.Blocktypes.STONE);
        mapArray[2][3] = new BlockGeneral(2, 3, BlockGeneral.Blocktypes.AIR);
        mapArray[3][3] = new BlockGeneral(3, 3, BlockGeneral.Blocktypes.AIR);
        mapArray[4][3] = new BlockGeneral(4, 3, BlockGeneral.Blocktypes.AIR);
